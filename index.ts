...
let enemies : string[] = ['Hulk', 'Zombie', 'Warrior', 'Thor'];
...
while (running)
    ...
    while (enemyHealth > 0)
        ...
        switch (control.command) {
            ...
            console.log(`\n\tYou Strike the ${enemy} with ${strikeDamage} damage.`);
    ...
    console.log(`\t You have ${health} Health Power left `);
    playerLevel++;
